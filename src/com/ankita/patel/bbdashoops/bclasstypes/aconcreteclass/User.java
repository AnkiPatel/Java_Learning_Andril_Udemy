package com.ankita.patel.bbdashoops.bclasstypes.aconcreteclass;

//Example of concrete class:
// It is the type of class where all methods will have implementation. 
...
public class User {
	...
	private ShoppedProduct[] products;
	...
	public ShoppedProduct[] getProducts() {
		return products;
	}
	public void setProducts(ShoppedProduct[] products) {
